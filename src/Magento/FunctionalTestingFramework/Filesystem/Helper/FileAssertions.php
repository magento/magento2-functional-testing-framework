...
namespace Magento\FunctionalTestingFramework\Filesystem\Helper;

use Codeception\Lib\ModuleContainer;
use Magento\AwsS3\Test\Mftf\Helper\S3FileAssertions;
...
class FileAssertions extends Helper implements FileAssertionsInterface
{
    ...
    {
        file_put_contents('env-file-assertions.txt', var_export(getenv(), true));
        parent::__construct($moduleContainer, $config);
        if (!empty(getenv('MEDIA_STORAGE_DRIVER')) && getenv('MEDIA_STORAGE_DRIVER') == self::STORAGE_TYPE_S3) {
            ...
            $this->storageType = self::STORAGE_TYPE_LOCAL;
        }
    }
