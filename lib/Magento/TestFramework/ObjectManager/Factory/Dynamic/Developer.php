 ...
 */
namespace Magento\TestFramework\ObjectManager\Factory\Dynamic;

/**
 * Class Developer
 */
class Developer implements \Magento\TestFramework\ObjectManager\FactoryInterface
{
    /**
     * Object manager
     *
     ...
     *
     * @var \Magento\TestFramework\ObjectManager\ConfigInterface
     */
    protected $config;
     ...
     * Definition list
     *
     * @var \Magento\TestFramework\ObjectManager\DefinitionInterface
     */
     ...
     * @param \Magento\TestFramework\ObjectManager\DefinitionInterface $definitions
     * @param array $globalArguments
     */
    public function __construct(
        \Magento\TestFramework\ObjectManager\ConfigInterface $config,
        \Magento\TestFramework\ObjectManagerInterface $objectManager = null,
        \Magento\TestFramework\ObjectManager\DefinitionInterface $definitions = null,
        $globalArguments = []
    ) {
        $this->config = $config;
        $this->objectManager = $objectManager;
        $this->definitions = $definitions ?: new \Magento\TestFramework\ObjectManager\Definition\Runtime();
     ...
     * @return void
     */
    public function setObjectManager(\Magento\TestFramework\ObjectManagerInterface $objectManager)
    {
        $this->objectManager = $objectManager;
    }
