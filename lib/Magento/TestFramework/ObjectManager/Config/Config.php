...
use Magento\TestFramework\ObjectManager\DefinitionInterface;
use Magento\TestFramework\ObjectManager\RelationsInterface;

/**
 * Class Config
 */
class Config implements \Magento\TestFramework\ObjectManager\ConfigInterface
{
    /**
     * Class definitions
     *
    ...
    {
        $this->_relations = $relations ? : new \Magento\TestFramework\ObjectManager\Relations\Runtime();
        $this->_definitions = $definitions ? : new \Magento\TestFramework\ObjectManager\Definition\Runtime();
    }
