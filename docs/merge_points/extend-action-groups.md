...
```xml
<actionGroup name="FillAdminSimpleProductFormWithMyExtensionActionGroup" extends="FillAdminSimpleProductForm>
    <!-- This will be added after the step ActionGroup"fillQuantity" on line 12 in the above test. -->
...
<actionGroup name="FillAdminSimpleProductFormWithMyExtensionActionGroup">
    <arguments>
        <argument name="category"/>
        <argument name="simpleProduct"/>
    </arguments>
